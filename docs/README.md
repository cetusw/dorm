...
- Бизнес-правила: [дежурства](./domain/duties.md), [задачи](./domain/tasks.md), [индивидуальные задания](./domain/individual-tasks.md), [команды](./domain/teams.md), [жители](./domain/residents.md), [предупреждения](./domain/penalties.md), [уведомления](./domain/notifications.md)
