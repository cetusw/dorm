...
Глава общежития и глава любой группы своего текущего общежития имеют management scope всех индивидуальных заданий этого общежития. Scope определяется по сохранённому `individual_task.dormitory_id`, а не по текущему общежитию жителя. Обычный житель видит и завершает только собственные задачи.
...
| Взять/вернуть/завершить задачу | активный `duty_participant`, пока дежурство активно или пока у прошедшего дежурства есть незакрытые задачи |
| Подтвердить/переоткрыть задачу | фактический `duty.leader_id` |
| Менять состав текущего Duty | глава общежития в его общежитии, глава группы в своей группе или фактический лидер Duty |
| Создать дежурство группы вручную | только глава группы |
| Менять настройки задач и постоянных Team группы | только глава группы |
| Открыть вкладку «Исполнители» и менять состав текущего Duty | глава общежития в его общежитии, глава группы в своей группе или фактический лидер Duty |
| Управлять общежитиями, группами, жителями, территориями, каталогом задач | только глава любого общежития |
| Управлять предупреждениями | глава общежития в пределах своего общежития; иначе глава группы в пределах своего текущего общежития |
